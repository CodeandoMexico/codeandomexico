...
<body>
	...
	<div class="team-section spad">
		...
		<div class="container">
			<div class="section-title">
				<h2>Conoce nuestras <span>historias</span> en Aulas</h2>
			</div>
			<div class="row">
				<!-- single member  -->
							...
							<div class="col-md-6">
								...
								<div class="container-fluid social-icons">
									<div class="row">
										<div>
											<div class="col-md-2">
												<a href="https://www.facebook.com/CodeandoMexico/" target="_blank"><i href="" class="fab fa-facebook-f"></i></a>
											</div>
											<div class="col-md-2">
	...
	<footer class="footer-section">
		<h2>2020 <a href="https://codeandomexico.org" target="_blank">Codeando México</a></h2>
	</footer>
	<!-- Footer section end -->
