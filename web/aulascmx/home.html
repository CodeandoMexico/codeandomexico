...
<html lang="es">
<head>
	<title>Aulas CMX</title>
	<meta charset="UTF-8">
	<meta name="description" content="Aulas CMX">
	<meta name="keywords" content="educacion, tecnologia, codeando, codeando mexico">
...
<body>
	...
	<div class="hero-section">
		<div class="hero-content">
			<div class="hero-center">
				...
				<!--<p>Empoderando a la ciudadanía con tecnología cívica</p> -->
			</div>
		</div>
		<!-- slider -->
				...
				<div class="intro-video">
					<div class="row">
						<div class="col-md-8 col-md-offset-2">
							...
							<a href="https://www.youtube.com/watch?v=4T-9PY4ZgtE" class="video-popup">
	...
	<!-- Contact section -->
	<div id="contacto" class="contact-section spad fix">
		<div class="container">
			<div class="row">
				<!-- contact info -->
							...
							<div class="col-md-6">	
								...
								<div class="container-fluid social-icons">
									<div class="row">
										<div>
											<div class="col-md-2">
												<i href="https://www.facebook.com/CodeandoMexico/" class="fab fa-facebook-f" target="_blank"></i>
											</div>
											<div class="col-md-2">
												<i href="https://twitter.com/CodeandoMexico" class="fab fa-twitter" target="_blank"></i>
											</div>
											<div class="col-md-2">
												<i href="https://github.com/CodeandoMexico" class="fab fa-github" target="_blank" ></i>
											</div>
	...
	<footer class="footer-section">
		<h2>2018 <a href="https://codeandomexico.org" target="_blank">Codeando México</a></h2>
	</footer>
	<!-- Footer section end -->
